...
return [
    ...
    'sections' => 'الأقسام',
    'sort_order' => 'الترتيب',
    'icon_help' => 'يُفضّل استخدام إيموجي — يظهر على بطاقة القسم في المتجر.',
    'username_help' => 'تسجّل الدخول بهذا الاسم. تغييره يغيّر بيانات دخولك.',
    'country_code' => 'رمز الاتصال الدولي',
    'country_code_help' => 'يظهر قبل كل رقم هاتف محلي، مثل ‎+961.',
    'working_hours' => 'ساعات الدوام',
    'working_hours_help' => 'اتركها كما هي ليبقى المندوب متاحًا طوال الوقت.',
    'on_duty' => 'على الدوام',
    'shift_start' => 'من',
    'shift_end' => 'حتى',
    'off_shift' => 'خارج الدوام',
    'starts_at' => 'يبدأ :time',
    'driver_status_help' => 'اختر «مشغول» أو «غير متصل» لإيقاف المندوب بغض النظر عن ساعات دوامه.',
    'driver_delivery_fee' => 'رسوم التوصيل',
    'driver_delivery_fee_help' => 'اختياري. اتركه فارغًا لاستخدام الرسوم الأساسية من الإعدادات.',
    'uses_base_fee' => 'الرسوم الأساسية',
    'inactive' => 'غير مُفعّل',
    'image' => 'الصورة',
    'logo' => 'الشعار',
    'image_help' => 'تُحوّل تلقائيًا إلى WebP ويُصغّر حجمها — ارفع الصورة الأصلية بدون ضغطها.',
];
